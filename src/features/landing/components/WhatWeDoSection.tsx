  ...
  return (
    <section ref={sectionRef} className="bg-white py-24 px-6 border-t border-[#f0f0f0]">
      <div className="max-w-5xl mx-auto">
        ...
        >
          {cards.map((card) => (
            <div key={card.title} className="flex items-start gap-4 bg-[#f7f7f7] border border-[#f0f0f0] rounded-2xl px-6 py-5 hover:border-[#e2e2e2] transition-all duration-200">
