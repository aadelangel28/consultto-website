...
// ─── Use-case card icons (order matches useCases.items in translations) ────────

const USE_CASE_ICONS = [
  <svg key="0" className="w-8 h-8 text-[#763d50]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
  </svg>,
  <svg key="1" className="w-8 h-8 text-[#763d50]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
  </svg>,
  <svg key="2" className="w-8 h-8 text-[#763d50]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z" />
  </svg>,
  <svg key="3" className="w-8 h-8 text-[#763d50]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
  </svg>,
  <svg key="4" className="w-8 h-8 text-[#763d50]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" />
  </svg>,
  <svg key="5" className="w-8 h-8 text-[#763d50]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 3.741-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
  </svg>,
  <svg key="6" className="w-8 h-8 text-[#763d50]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
  </svg>,
  <svg key="7" className="w-8 h-8 text-[#763d50]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
  </svg>,
]

// ─── Feature mockup backgrounds (static) ─────────────────────────────────────

const FEATURE_MOCKUP_BGS = ['#faf5f6', '#f0f3f5', '#faf5f6', '#f0f3f5']
...
function DemoChatSection() {
  const { t } = useLanguage()
  const CHAT_MESSAGES = t.agenteIA.chat.messages
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center px-6">
        <div className="w-full max-w-[360px] rounded-2xl overflow-hidden shadow-2xl shadow-black/70" style={{ border: '1px solid rgba(255,255,255,0.09)' }}>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="flex items-center gap-1 mt-0.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse"/>
                  <p className="text-white/40 text-[10px]">{t.agenteIA.chat.onlineLabel}</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white border-t border-[#f0f0f0] px-4 py-3 flex items-center gap-2">
            <input readOnly placeholder={t.agenteIA.chat.inputPlaceholder} className="flex-1 text-sm text-[#3a3a3a]/35 placeholder-[#3a3a3a]/25 bg-transparent outline-none cursor-default"/>
...
export function AgenteIAPage() {
  ...
  // Build feature mockup content from translations
  const featureMockupContents = [
    /* Feature 0 — Chat mockup */
    <div key="f0" className="flex flex-col gap-3 p-5">
      <div className="flex items-center gap-2 mb-1">
        <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
        <span className="text-[#763d50] text-xs font-semibold uppercase tracking-widest">{ai.features.items[0].onlineLabel}</span>
      </div>
      {ai.features.items[0].messages!.map((msg, i) => (
        <div
          key={i}
      ...
      <div className="flex items-center gap-2 self-start mt-1">
        ...
        <span className="text-[10px] text-[#3a3a3a]/40">{ai.features.items[0].generando}</span>
      </div>
    </div>,
    /* Feature 1 — Context mockup */
    <div key="f1" className="p-5 flex flex-col gap-3">
      <p className="text-[#2e3e49] text-xs font-semibold uppercase tracking-widest mb-1">{ai.features.items[1].contextLabel}</p>
      {ai.features.items[1].contextItems!.map(item => (
    ...
    /* Feature 2 — Document mockup */
    <div key="f2" className="p-5 flex flex-col gap-2.5">
      <div className="flex items-center justify-between mb-1">
        <p className="text-[#763d50] text-xs font-semibold uppercase tracking-widest">{ai.features.items[2].docLabel}</p>
        <span className="bg-green-100 text-green-700 text-[10px] font-semibold px-2 py-0.5 rounded-full">{ai.features.items[2].docStatus}</span>
      </div>
      <div className="bg-white rounded-xl border border-[#e8e8e8] p-4 flex flex-col gap-2">
        <p className="text-[#1f2020] text-xs font-bold">{ai.features.items[2].docTitle}</p>
        <p className="text-[#3a3a3a]/50 text-[10px]">{ai.features.items[2].docMeta}</p>
        <div className="border-t border-[#f0f0f0] pt-2 mt-1 flex flex-col gap-1.5">
          {ai.features.items[2].docSections!.map(s => (
    ...
    /* Feature 3 — Audit mockup */
    <div key="f3" className="p-5 flex flex-col gap-3">
      <div className="flex items-center justify-between mb-1">
        <p className="text-[#2e3e49] text-xs font-semibold uppercase tracking-widest">{ai.features.items[3].auditLabel}</p>
        <span className="text-[10px] text-[#3a3a3a]/40">{ai.features.items[3].daysLeft}</span>
      </div>
      {ai.features.items[3].clauses!.map(item => (
        <div key={item.clause} className="flex items-center justify-between bg-white rounded-lg px-3 py-2 border border-[#e8e8e8]">
          ...
          <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${
            ...
            {item.status === 'ok' ? ai.features.items[3].statusOk : item.status === 'warn' ? ai.features.items[3].statusWarn : ai.features.items[3].statusErr}
          </span>
        </div>
      ))}
    </div>,
    ...
    <main className="bg-white pt-20 md:pt-24">
      ...
      <section className="relative overflow-hidden bg-white px-6 pt-14 pb-16 md:pt-20 md:pb-28">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            {ai.hero.h1Part1}{' '}
            <span className="text-[#763d50]">{ai.hero.h1Highlight}</span>
          </h1>
          <p
              ...
              <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-16 items-center`}>
                ...
                <Reveal className="flex-1 w-full" from={isEven ? 'right' : 'left'} delay={150}>
                  <div
                    ...
                    style={{ backgroundColor: FEATURE_MOCKUP_BGS[i] }}
                  >
                    {/* Window bar */}
                    <div className="bg-[#2e3e49] px-4 py-2.5 flex items-center gap-2">
                      ...
                      <div className="w-2.5 h-2.5 rounded-full bg-[#d9d9d9]/40" />
                      <span className="ml-3 text-[#d9d9d9]/40 text-xs font-mono">Consultto · {ai.hero.badge}</span>
                    </div>
                    {featureMockupContents[i]}
                  </div>
                </Reveal>
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal className="text-center mb-10 md:mb-16">
            ...
            <p className="text-[#3a3a3a]/60 text-base leading-relaxed max-w-2xl mx-auto">
              {ai.useCases.subtitle}
            </p>
          </Reveal>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {ai.useCases.items.map((uc, i) => (
              <Reveal key={uc.title} delay={i * 60} from="bottom">
                <div className="bg-[#fafafa] border border-[#f0f0f0] rounded-2xl p-6 h-full hover:border-[#763d50]/20 hover:bg-[#fdf8f9] transition-all duration-300">
                  <div className="mb-4">{USE_CASE_ICONS[i]}</div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <Reveal>
            ...
            <h2 className="text-3xl md:text-5xl font-light text-[#1f2020] leading-tight mb-6">
              {ai.cta.title1}<br />
              <span className="font-bold">{ai.cta.titleBold}</span>
            </h2>
