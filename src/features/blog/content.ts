...
export const articleContent: ArticleContent[] = [
  ...
  {
    slug: 'digitalizar-plan-haccp',
    body: [
      { type: 'paragraph', content: 'El plan HACCP es el corazón del sistema de inocuidad alimentaria. Documenta los peligros, los puntos críticos de control, los límites y los registros de monitoreo que demuestran que los alimentos que produce tu empresa son seguros. Y aun así, la gran mayoría de plantas lo llevan en Excel.' },
      { type: 'paragraph', content: 'No es un problema de intención. Es un problema de escala. Un Excel funciona cuando tienes un producto, una línea y un auditor comprensivo. Deja de funcionar cuando tienes múltiples líneas, cambios frecuentes de formulación, equipos rotativos y auditores de certificación que exigen evidencia trazable, fechada y firmada.' },
      { type: 'heading', content: 'Por qué Excel no es suficiente para HACCP' },
      { type: 'paragraph', content: 'El problema con Excel no es la herramienta en sí — es lo que no puede garantizar. Un archivo de Excel no tiene control de versiones real: cualquier persona puede editarlo, guardarlo encima de la versión anterior y nadie sabe qué cambió ni cuándo. En una auditoría de inocuidad, eso es una no conformidad directa.' },
      { type: 'bullets', content: [
        'No hay trazabilidad de quién modificó qué y cuándo',
        'Los registros de monitoreo de PCCs pueden editarse retroactivamente sin dejar rastro',
        'No hay flujo de aprobación: cualquiera puede cambiar un límite crítico sin autorización',
        'No se pueden adjuntar evidencias fotográficas directamente al registro',
        'La búsqueda de registros históricos en auditorías toma horas',
      ]},
      { type: 'quote', content: 'En una auditoría FSSC 22000, el auditor no solo revisa que el plan existe — revisa que los registros de monitoreo son confiables y no pudieron alterarse.' },
      { type: 'heading', content: 'Qué debe poder hacer un sistema digital de HACCP' },
      { type: 'paragraph', content: 'Antes de elegir cualquier herramienta, define qué necesitas que haga. Un sistema digital para HACCP no es simplemente mover el Excel a la nube. Debe resolver los problemas estructurales que Excel no puede.' },
      { type: 'bullets', content: [
        'Control de versiones con historial de cambios auditables',
        'Registro de monitoreo de PCCs con firma digital del operador y fecha/hora inmutable',
        'Alertas automáticas cuando un límite crítico es superado',
        'Flujo de aprobación para cambios al plan HACCP',
        'Acceso desde dispositivos móviles para operadores en planta',
        'Generación de reportes de registros para auditorías en minutos',
      ]},
      { type: 'heading', content: 'Cómo hacer la transición sin detener la operación' },
      { type: 'paragraph', content: 'La migración de Excel a un sistema digital no tiene que hacerse de golpe. El enfoque más efectivo es una transición paralela: durante 4 a 6 semanas, los operadores registran en ambos sistemas simultáneamente. Esto permite detectar errores de configuración, capacitar al equipo sin presión y validar que los registros digitales son equivalentes a los físicos antes de prescindir de ellos.' },
      { type: 'subheading', content: 'Fase 1: Digitalizar el plan HACCP (semanas 1-2)' },
      { type: 'paragraph', content: 'Carga el análisis de peligros, los PCCs, los límites críticos, los procedimientos de monitoreo y las acciones correctivas predefinidas en el sistema. Revisa que cada PCC tenga su límite crítico claramente definido y su responsable asignado.' },
      { type: 'subheading', content: 'Fase 2: Capacitar a operadores (semanas 2-3)' },
      { type: 'paragraph', content: 'Los operadores de planta son los que registran el monitoreo de PCCs en tiempo real. La capacitación debe ser práctica y en el piso de producción, no en sala de juntas. Si el sistema no es intuitivo para un operador con tablet, el problema es del sistema, no del operador.' },
      { type: 'subheading', content: 'Fase 3: Operación paralela y validación (semanas 3-6)' },
      { type: 'paragraph', content: 'Corre ambos sistemas en paralelo. Al final del período, compara los registros. Si son consistentes, el sistema digital está listo para ser el único registro oficial. Documenta la validación — el auditor puede pedirla.' },
      { type: 'heading', content: 'El momento de la auditoría' },
      { type: 'paragraph', content: 'El valor real de digitalizar el HACCP se ve cuando llega el auditor. En lugar de buscar carpetas, imprimir registros y explicar por qué falta la firma de un operador de turno nocturno de hace tres meses, puedes mostrar cualquier registro histórico en segundos, con la firma digital del operador, la fecha y hora exacta, y el nombre del supervisor que lo revisó.' },
      { type: 'paragraph', content: 'Eso no es solo comodidad. Es la diferencia entre una auditoría sin hallazgos y una auditoría con no conformidades que retrasan tu certificación.' },
      { type: 'related', content: 'Páginas relacionadas', links: [
        { label: 'Gestión de inocuidad alimentaria con Consultto', href: '/industrias/alimentos-y-bebidas' },
        { label: 'ISO 22000: inocuidad alimentaria', href: '/normas/iso-22000' },
        { label: 'FSSC 22000 vs ISO 22000', href: '/blog/fssc-22000-vs-iso-22000' },
        { label: 'No conformidades más comunes en auditorías de inocuidad', href: '/blog/no-conformidades-auditoria-inocuidad' },
      ]},
    ],
  },
  {
    slug: 'fssc-22000-vs-iso-22000',
    body: [
      { type: 'paragraph', content: 'Cuando una empresa de alimentos empieza a evaluar qué certificación de inocuidad necesita, casi inevitablemente aparecen dos nombres: ISO 22000 y FSSC 22000. Son parecidos, están relacionados, y generan confusión permanente. La pregunta real no es cuál es mejor — es cuál te pide tu cliente o tu mercado de exportación.' },
      { type: 'heading', content: 'Qué es ISO 22000' },
      { type: 'paragraph', content: 'ISO 22000 es una norma internacional publicada por la Organización Internacional de Normalización (ISO). Define los requisitos para un sistema de gestión de la inocuidad de los alimentos. Integra los principios HACCP del Codex Alimentarius con los elementos de un sistema de gestión completo: política, objetivos, comunicación, mejora continua y revisión por la dirección.' },
      { type: 'paragraph', content: 'ISO 22000 aplica a cualquier organización en la cadena alimentaria: productores primarios, procesadores, transportistas, distribuidores, proveedores de empaques y servicios de limpieza para plantas de alimentos. Su alcance es amplio y su adopción es voluntaria, aunque muchos clientes corporativos la exigen como requisito contractual.' },
      { type: 'heading', content: 'Qué es FSSC 22000' },
      { type: 'paragraph', content: 'FSSC 22000 (Food Safety System Certification 22000) es un esquema de certificación, no una norma. Fue desarrollado por la Fundación FSSC y está reconocido por la Global Food Safety Initiative (GFSI). No reemplaza a ISO 22000 — la incluye y le agrega requisitos adicionales específicos por sector.' },
      { type: 'paragraph', content: 'Para certificarse en FSSC 22000, una empresa debe cumplir con ISO 22000, más un programa de prerrequisitos específico de su sector (por ejemplo, ISO/TS 22002-1 para manufactura de alimentos), más los requisitos adicionales propios del esquema FSSC. Es más exigente y más reconocido globalmente que ISO 22000 por sí sola.' },
      { type: 'heading', content: 'Diferencias clave en una tabla' },
      { type: 'bullets', content: [
        'Base normativa — ISO 22000: norma ISO independiente. FSSC 22000: ISO 22000 + programa de prerrequisitos sectoriales + requisitos FSSC adicionales',
        'Reconocimiento GFSI — ISO 22000: no reconocida por GFSI. FSSC 22000: sí reconocida por GFSI',
        'Requisito de grandes retailers — ISO 22000: aceptada por algunos. FSSC 22000: exigida por Walmart, Costco, Carrefour y otros',
        'Auditoría — ISO 22000: cualquier organismo de certificación acreditado. FSSC 22000: solo organismos aprobados por la Fundación FSSC',
        'Costo y complejidad — ISO 22000: menor. FSSC 22000: mayor, más requisitos específicos',
      ]},
      { type: 'quote', content: 'Si tu cliente es un gran retailer internacional o exportas a Europa o Norteamérica, casi seguro necesitas FSSC 22000, no solo ISO 22000.' },
      { type: 'heading', content: 'Cuándo es suficiente ISO 22000' },
      { type: 'paragraph', content: 'ISO 22000 es suficiente cuando tus clientes la aceptan específicamente, cuando operas en un mercado local o regional donde GFSI no es un requisito contractual, o cuando eres un proveedor de servicio en la cadena alimentaria (transporte, almacenamiento) y no un productor directo de alimentos.' },
      { type: 'paragraph', content: 'También es el punto de partida natural: muchas empresas se certifican primero en ISO 22000 y luego escalan a FSSC 22000 cuando su mercado lo exige. La transición es relativamente directa porque ya tienen la base del sistema construida.' },
      { type: 'heading', content: 'Cuándo necesitas FSSC 22000' },
      { type: 'paragraph', content: 'Necesitas FSSC 22000 si exportas o planeas exportar a mercados que exigen certificación reconocida por GFSI: Estados Unidos, Canadá, la Unión Europea, Reino Unido o Australia. También si provees a grandes cadenas de retail (Walmart, Soriana, Chedraui, Costco) que tienen políticas de proveedores con estándares GFSI. Y si compites por contratos con empresas multinacionales de alimentos que auditan su cadena de proveedores.' },
      { type: 'heading', content: 'Cómo prepararte para la certificación' },
      { type: 'paragraph', content: 'El proceso de certificación en cualquiera de los dos esquemas sigue una estructura similar. Primero, la implementación del sistema: análisis de peligros, definición de PCCs y PROs, documentación de procedimientos y registros. Segundo, una auditoría interna para verificar que el sistema funciona. Tercero, la auditoría de certificación por el organismo externo.' },
      { type: 'bullets', content: [
        'Define tu alcance: qué productos y procesos incluirás en la certificación',
        'Identifica el programa de prerrequisitos sectoriales que aplica a tu proceso',
        'Construye o actualiza tu análisis de peligros HACCP',
        'Documenta tus PROs (programas de prerrequisitos operativos)',
        'Realiza una auditoría interna antes de la certificación',
        'Elige un organismo de certificación aprobado para el esquema que necesitas',
      ]},
      { type: 'related', content: 'Páginas relacionadas', links: [
        { label: 'FSSC 22000 — Cómo gestionarlo con Consultto', href: '/normas/fssc-22000' },
        { label: 'ISO 22000 — Inocuidad alimentaria', href: '/normas/iso-22000' },
        { label: 'Prerrequisitos operativos en ISO 22000', href: '/blog/prerrequisitos-operativos-iso-22000' },
        { label: 'Gestión de inocuidad para alimentos y bebidas', href: '/industrias/alimentos-y-bebidas' },
      ]},
    ],
  },
  {
    slug: 'no-conformidades-auditoria-inocuidad',
    body: [
      { type: 'paragraph', content: 'Las auditorías de inocuidad alimentaria — ya sea bajo ISO 22000, FSSC 22000, BRC o IFS — siguen patrones reconocibles. Los auditores experimentados saben exactamente dónde buscar. Y las mismas no conformidades aparecen una y otra vez, en plantas distintas, en países distintos, en diferentes certificaciones. Conocerlas de antemano es una ventaja que muchas empresas no aprovechan.' },
      { type: 'paragraph', content: 'Esta lista está basada en los hallazgos más frecuentes en auditorías de inocuidad. No son hipotéticas — son los puntos que los auditores revisan primero porque saben que es donde más frecuentemente encuentran desviaciones.' },
      { type: 'heading', content: '1. Registros de monitoreo de PCCs incompletos o con correcciones manuales no justificadas' },
      { type: 'paragraph', content: 'Es la no conformidad más común. El auditor solicita los registros de monitoreo de puntos críticos de control de los últimos tres meses y encuentra: campos en blanco, valores fuera de límite sin acción correctiva documentada, o correcciones manuales (tachaduras, corrector) sin firma ni justificación.' },
      { type: 'paragraph', content: 'El estándar exige que cualquier corrección en un registro sea identificable: fecha, nombre del responsable y motivo de la corrección. Un registro alterado sin estas marcas es evidencia de control deficiente — o peor, de manipulación de datos.' },
      { type: 'heading', content: '2. Análisis de peligros desactualizado respecto a los productos actuales' },
      { type: 'paragraph', content: 'El análisis de peligros debe reflejar los productos que la planta elabora actualmente. Cuando una empresa lanza un nuevo producto, cambia una formulación o incorpora un nuevo ingrediente, el análisis de peligros debe actualizarse. En muchas auditorías se encuentran análisis de hace dos o tres años que no contemplan cambios en la línea de producción.' },
      { type: 'paragraph', content: 'Esta no conformidad es especialmente crítica porque indica que el sistema HACCP no está controlando los peligros reales del proceso actual.' },
      { type: 'heading', content: '3. Programas de prerrequisitos sin evidencia de monitoreo' },
      { type: 'paragraph', content: 'Los programas de prerrequisitos (limpieza y desinfección, control de plagas, higiene del personal, mantenimiento preventivo) deben monitorearse y registrarse. No es suficiente tener el procedimiento documentado — debe haber evidencia de que se ejecuta.' },
      { type: 'bullets', content: [
      ...
      { type: 'heading', content: '4. Límites críticos sin validación científica documentada' },
      { type: 'paragraph', content: 'Los límites críticos de los PCCs deben estar respaldados por evidencia científica o regulatoria. Un límite de temperatura de cocción de 74°C para eliminación de Salmonella no puede estar basado en una estimación — debe citar la fuente: Codex Alimentarius, FDA, norma oficial o estudio validado.' },
      { type: 'paragraph', content: 'La ausencia de validación documentada convierte un límite crítico en una suposición, lo que invalida toda la lógica del PCC.' },
      { type: 'heading', content: '5. Personal sin capacitación documentada en HACCP e inocuidad' },
      { type: 'paragraph', content: 'ISO 22000 y FSSC 22000 exigen que el personal que opera los PCCs y los que participan en el equipo de inocuidad tengan competencia demostrada. Eso significa registros de capacitación actualizados, con evidencia del contenido impartido y la evaluación de comprensión.' },
      { type: 'paragraph', content: 'La no conformidad más frecuente en este punto es encontrar operadores de línea — que registran el monitoreo de PCCs diariamente — sin capacitación documentada en los últimos 12 meses.' },
      { type: 'heading', content: '6. Acciones correctivas ante desviaciones sin investigación de causa raíz' },
      { type: 'paragraph', content: 'Cuando un límite crítico se supera, la norma exige una acción correctiva que incluya disposición del producto afectado, investigación de causa raíz y acción para evitar recurrencia. En muchas plantas, cuando un PCC se desvía, el operador registra "se ajustó el equipo" y cierra el registro. Eso no es una acción correctiva — es una corrección sin análisis.' },
      { type: 'quote', content: 'Una desviación de PCC sin investigación de causa raíz documentada es una no conformidad mayor en prácticamente todos los esquemas de inocuidad.' },
      { type: 'heading', content: '7. Plan de retiro y trazabilidad sin prueba de ejercicio' },
      { type: 'paragraph', content: 'Todas las certificaciones de inocuidad exigen un procedimiento de retiro de producto del mercado y un sistema de trazabilidad que permita identificar el origen y destino de cualquier lote. Pero no es suficiente tener el procedimiento escrito — debe existir evidencia de que se ejercitó, aunque sea en simulacro.' },
      { type: 'paragraph', content: 'Un ejercicio de trazabilidad documentado (un drill donde se rastrea un lote específico desde la materia prima hasta el cliente en menos de 4 horas, por ejemplo) demuestra que el sistema funciona en la práctica. La ausencia de este ejercicio es una no conformidad recurrente.' },
      { type: 'heading', content: 'Cómo prepararte antes de la auditoría' },
      { type: 'bullets', content: [
      ...
      { type: 'related', content: 'Páginas relacionadas', links: [
        { label: 'Cómo digitalizar tu plan HACCP', href: '/blog/digitalizar-plan-haccp' },
        { label: 'Gestión de inocuidad para alimentos y bebidas', href: '/industrias/alimentos-y-bebidas' },
        { label: 'ISO 22000 — Inocuidad alimentaria', href: '/normas/iso-22000' },
        { label: 'FSSC 22000 vs ISO 22000', href: '/blog/fssc-22000-vs-iso-22000' },
      ]},
  ...
  {
    slug: 'prerrequisitos-operativos-iso-22000',
    body: [
      { type: 'paragraph', content: 'Dentro de ISO 22000, hay un concepto que genera más confusión que casi cualquier otro: los prerrequisitos operativos, conocidos como PROs. No son lo mismo que los programas de prerrequisitos generales. No son PCCs. Y entender exactamente qué son, cuándo aplican y cómo documentarlos puede ser la diferencia entre una auditoría limpia y una con hallazgos mayores.' },
      { type: 'heading', content: 'La jerarquía de controles en ISO 22000' },
      { type: 'paragraph', content: 'ISO 22000 establece tres tipos de medidas de control para gestionar los peligros para la inocuidad alimentaria. Entender la jerarquía es fundamental antes de hablar de los PROs.' },
      { type: 'bullets', content: [
        'Programas de prerrequisitos (PPR): medidas de control de condiciones básicas de operación — higiene, limpieza, control de plagas, mantenimiento. Reducen la probabilidad de peligros pero no están enfocados en un peligro específico',
        'Prerrequisitos operativos (PRO): medidas de control que reducen o previenen un peligro específico hasta un nivel aceptable, pero que no califican como PCC porque no son el punto donde se ejerce el control crítico',
        'PCCs (Puntos Críticos de Control): medidas de control en puntos específicos del proceso donde el control es esencial para prevenir o eliminar un peligro hasta un nivel aceptable',
      ]},
      { type: 'heading', content: 'Qué es un PRO exactamente' },
      { type: 'paragraph', content: 'Un PRO es una medida de control que la empresa selecciona para gestionar un peligro identificado en el análisis de peligros, cuando ese control no califica como PCC según la lógica del árbol de decisiones. A diferencia de un PPR general, un PRO está dirigido a un peligro específico identificado en el análisis.' },
      { type: 'paragraph', content: 'Ejemplo concreto: en una planta de lácteos, el control de temperatura de almacenamiento de materia prima puede ser un PRO para el crecimiento de patógenos, si la temperatura por sí sola no elimina el peligro (eso sería el proceso térmico posterior, el PCC) pero sí lo controla hasta un nivel manejable antes del proceso.' },
      { type: 'quote', content: 'Un PRO controla un peligro específico pero no en el punto crítico. Si el control falla, el peligro puede seguir siendo manejado en un paso posterior del proceso.' },
      { type: 'heading', content: 'Diferencia práctica entre PPR, PRO y PCC' },
      { type: 'bullets', content: [
        'PPR — Control de plagas: reduce la probabilidad de contaminación general. No está vinculado a un peligro específico en un paso del proceso',
        'PRO — Control de temperatura de almacenamiento de materia prima: controla el crecimiento de patógenos específicos antes del proceso térmico',
        'PCC — Pasteurización: elimina patógenos específicos de forma definitiva. Si falla, no hay control posterior que corrija el problema',
      ]},
      { type: 'heading', content: 'Cuántos PROs necesitas' },
      { type: 'paragraph', content: 'No hay un número fijo. Los PROs emergen del análisis de peligros: después de identificar todos los peligros biológicos, químicos y físicos en cada paso del proceso, el equipo de inocuidad evalúa cómo se controla cada uno. Los peligros que no llegan a PCC pero requieren un control específico se convierten en PROs.' },
      { type: 'paragraph', content: 'Una planta de producción de jugos puede tener entre 3 y 8 PROs. Una línea de panificación puede tener menos. Una planta de cárnicos procesados puede tener más de 10. Depende de la complejidad del proceso y el perfil de peligros de los productos.' },
      { type: 'heading', content: 'Cómo documentar un PRO correctamente' },
      { type: 'paragraph', content: 'ISO 22000 establece que la documentación de un PRO debe incluir, como mínimo, los peligros que controla, los criterios de acción, el procedimiento de monitoreo, las correcciones y acciones correctivas ante desviaciones, y las responsabilidades.' },
      { type: 'bullets', content: [
        'Peligro específico que controla: qué agente biológico, químico o físico está siendo controlado',
        'Criterio de acción: el valor o condición que, si no se cumple, indica pérdida de control',
        'Método y frecuencia de monitoreo: cómo y con qué frecuencia se verifica el control',
        'Responsable del monitoreo: quién registra y firma',
        'Acciones correctivas predefinidas: qué se hace si el criterio no se cumple',
        'Registros: evidencia de que el monitoreo se ejecuta',
      ]},
      { type: 'heading', content: 'El error más común con los PROs' },
      { type: 'paragraph', content: 'El error más frecuente que encuentran los auditores es que las empresas documentan los PROs como procedimientos generales (parecidos a un PPR) sin vincularlos explícitamente a un peligro específico identificado en el análisis de peligros. El auditor pregunta: ¿qué peligro controla este PRO? y el equipo no puede responder con precisión.' },
      { type: 'paragraph', content: 'Cada PRO debe tener una línea directa de regreso al análisis de peligros. Si no puedes decir exactamente qué peligro controla, en qué paso del proceso y por qué no es un PCC, la documentación es incompleta.' },
      { type: 'related', content: 'Páginas relacionadas', links: [
        { label: 'ISO 22000 — Inocuidad alimentaria', href: '/normas/iso-22000' },
        { label: 'FSSC 22000 vs ISO 22000', href: '/blog/fssc-22000-vs-iso-22000' },
        { label: 'Cómo digitalizar tu plan HACCP', href: '/blog/digitalizar-plan-haccp' },
